...
# gawk, find, xgettext, g$localgsed, python, msguniq, msgmerge, msgattrib, msgfmt, msginit
#
...
OLDIFS=$IFS
IFS=" "
printf "\n"; read -n1 -r -p "Press 'M' to continue with generating .mo files or use any key to continue" key; printf "\n"
